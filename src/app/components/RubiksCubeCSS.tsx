...
export default function RubiksCubeCSS({ cubeState, size = 3 }: RubiksCubeCSSProps) {
  ...
  const faceSize = size === 2 ? 100 : size === 4 ? 120 : size === 5 ? 130 : size === 6 ? 130 : size === 7 ? 130 : 150;
  const halfSize = faceSize / 2;
  const gridCols = size === 2 ? 'grid-cols-2' : size === 4 ? 'grid-cols-4' : size === 5 ? 'grid-cols-5' : size === 6 ? 'grid-cols-6' : size === 7 ? 'grid-cols-7' : 'grid-cols-3';
